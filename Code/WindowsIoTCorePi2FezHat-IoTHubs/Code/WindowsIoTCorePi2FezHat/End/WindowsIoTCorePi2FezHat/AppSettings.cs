...
namespace WindowsIoTCorePi2FezHat
{
    ...
    public class AppSettings
    {
        ...
        const string IoTDeviceConnectionStringKeyname = "namespace";
        ...
        const string IoTDeviceConnectionStringDefault = "";
        ...
        /// Property to get and set a Username Setting Key.
        /// </summary>
        public string IoTDeviceConnectionString
        {
            get
            {
                return GetValueOrDefault<string>(IoTDeviceConnectionStringKeyname, IoTDeviceConnectionStringDefault);
            }
            set
            {
                if (AddOrUpdateValue(IoTDeviceConnectionStringKeyname, value))
                {
                    Save();
                }
            }
